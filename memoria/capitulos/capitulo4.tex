...
\end{lstlisting}
\captionsetup{justification=centering}
\caption[Dataset usado en el presente trabajo. Las columna \textit{X} son las características, la columna \textit{y} es el tipo de clase.]{Dataset usado en el presente trabajo. Las columnas \textit{X} son las características, la columna \textit{y} es el tipo de clase.}
\label{cod:dataset}
\end{code}
