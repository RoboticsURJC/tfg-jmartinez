...
def compare_angles(images_neutral, images_emotion):
    ...
    for i in range(len(images_emotion)):
        ...
        for i in range(emotionalmesh.num_angles-1):
...
if __name__ == '__main__':
    ...
    angles_names = ["Angle 0", "Angle 1", "Angle 2", "Angle 3", "Angle 4", "Angle 5", "Angle 6", 
    "Angle 7", "Angle 8", "Angle 9", "Angle 10", "Angle 11", "Angle 12", "Angle 13", "Angle 14", 
    "Angle 15", "Angle 16", "Angle 17", "Angle 18", "Angle 19", "Angle 20"]
